...
('admin',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'System Administrator', 'Admin',  1),
('viewer', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr/TS5rJ/UFc6B0Ui', 'Read Only Viewer',     'Viewer', 1);
...
INSERT INTO tbl_drugs
  (drug_name, generic_name, category, manufacturer, batch_number,
   mfg_date, expiry_date, uom, qty_in_stock, reorder_level, storage_condition)
VALUES
-- 1. Expired drug
('Amoxicillin 500mg', 'Amoxicillin', 'Antibiotic', 'Sun Pharma', 'BN-2021-001',
 '2021-01-01', '2022-12-31', 'Capsule', 50, 20, 'Store below 25°C'),
